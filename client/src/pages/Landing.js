  ...
  return (
    <Container fullHeight contentCenteredMobile padding="4rem 2rem 2rem 2rem">
      <CenteredBlockWithAnimation>
        <Hider hideOnDesktop>
          <MobileIllustration src={illustrationMobile} alt="MossPok" />
        </Hider>
        <Markdown>
          <MarketingHeadline
            as="h2"
            ...
            dangerouslySetInnerHTML={{
              __html: getLocalizedString('Welcome to MossPok!'),
            }}
          />
        </Markdown>
        ...
        <Markdown>
          <MarketingHeadline
            ...
            textCenteredOnMobile
            dangerouslySetInnerHTML={{
              __html: getLocalizedString('Play with friends or join public games'),
            }}
          />
        </Markdown>
        <Wrapper>
      ...
      <Hider hideOnMobile>
        <DesktopIllustration src={illustrationDesktop} alt="MossPok" />
      </Hider>
    </Container>
  );
};
