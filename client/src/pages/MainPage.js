      ...
      <MainMenuWrapper>
        <MainMenuCard onClick={() => history.push('/play')}>
          ...
          <Heading as="h3" headingClass="h5" textCentered>
            {getLocalizedString('Join table').toUpperCase()}
          </Heading>
        </MainMenuCard>
        <MainMenuCard onClick={() => history.push('/play')}>
          <img src={queen2Img} alt="Quick Game" />
          <Heading as="h3" headingClass="h5" textCentered>
            {getLocalizedString('Quick Game').toUpperCase()}
          </Heading>
        </MainMenuCard>
        <MainMenuCard
          onClick={() => {
            openModal(
              () => (
                <Text textAlign="center">
                  {getLocalizedString('Shop coming soon')}
                </Text>
              ),
              getLocalizedString('Shop'),
        ...
        >
          ...
          <Heading as="h3" headingClass="h5" textCentered>
            {getLocalizedString('Open Shop').toUpperCase()}
          </Heading>
        </MainMenuCard>
        <MainMenuCard onClick={() => history.push('/game-rules')}>
          <img src={queenImg} alt="Rules" />
          <Heading as="h3" headingClass="h5" textCentered>
            {getLocalizedString('Game Rules').toUpperCase()}
          </Heading>
        </MainMenuCard>
      </MainMenuWrapper>
    </Container>
