...
export const RABBIT_HUNT = 'RABBIT_HUNT';
export const RABBIT_HUNT_RESULT = 'RABBIT_HUNT_RESULT';
export const CREATE_ROOM = 'CREATE_ROOM';
export const ADMIN_METRICS_SUBSCRIBE = 'ADMIN_METRICS_SUBSCRIBE';
export const ADMIN_METRICS_UPDATE = 'ADMIN_METRICS_UPDATE';
